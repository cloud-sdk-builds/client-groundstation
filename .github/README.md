...
[`@aws-sdk/client-groundstation`](https://www.npmjs.com/package/@aws-sdk/client-groundstation/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-groundstation@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qfnSTByRbArhS/AOoX8T7XMOpYyz4NN+SO/9zwuNgaeSzH+mo15DcGLGRuSkfK/k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-groundstation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-groundstation@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-groundstation@3.882.0/index.min.mjs": "sha384-qfnSTByRbArhS/AOoX8T7XMOpYyz4NN+SO/9zwuNgaeSzH+mo15DcGLGRuSkfK/k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-groundstation/blob/refs/tags/3.882.0/LICENSE
```
